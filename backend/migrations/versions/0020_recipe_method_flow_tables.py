...
This published revision is intentionally retained after the Flow table feature
was removed. Existing installations may already be stamped with this revision,
so deleting it makes Alembic unable to upgrade those databases.
"""
