...
| Repository | `ghcr.io/clickme1234/slop-meal-planner:1.3.3` |
| Network Type | `Bridge` |
...
For the `v1.3.3` release, verify once that
`ghcr.io/clickme1234/slop-meal-planner:1.3.3` is public and that an
