...
export const demoPantry: PantryItem[] = [
  { id: 'p1', name: 'Basmati rice', initialQuantity: 1000, quantity: 900, unit: 'g', reserved: 450, quantityDisplay: '900 g', reservedDisplay: '450 g', usableDisplay: '450 g', category: 'Cupboard', staple: true },
  { id: 'p2', name: 'Eggs', initialQuantity: 12, quantity: 8, unit: 'eggs', reserved: 5, quantityDisplay: '8 eggs', reservedDisplay: '5 eggs', usableDisplay: '3 eggs', category: 'Dairy & eggs', expires: '18 Jul' },
  { id: 'p3', name: 'Greek yoghurt', initialQuantity: 1000, quantity: 500, unit: 'g', reserved: 350, quantityDisplay: '500 g', reservedDisplay: '350 g', usableDisplay: '150 g', category: 'Dairy & eggs', expires: '15 Jul' },
  { id: 'p4', name: 'Chickpeas', initialQuantity: 4, quantity: 3, unit: 'tins', reserved: 2, quantityDisplay: '3 tins', reservedDisplay: '2 tins', usableDisplay: '1 tin', category: 'Cupboard' },
  { id: 'p5', name: 'Olive oil', initialQuantity: 1000, quantity: 620, unit: 'ml', reserved: 90, quantityDisplay: '620 ml', reservedDisplay: '90 ml', usableDisplay: '530 ml', category: 'Cupboard', staple: true },
  { id: 'p6', name: 'Spinach', initialQuantity: 250, quantity: 180, unit: 'g', reserved: 150, quantityDisplay: '180 g', reservedDisplay: '150 g', usableDisplay: '30 g', category: 'Fruit & veg', expires: '14 Jul' }
]
...
export const initialShopping: ShoppingItem[] = [
  ...
  { id: 's4', name: 'Greek yoghurt', buy: '500 g', exact: '430 g required', pantryUsed: '150 g available in pantry', category: 'Dairy & eggs', checked: true, updatedAt: 1, unit: 'g', quantityOptions: [
    { unit: 'g', buy: '500 g', exact: '430 g required', approximate: false },
    { unit: 'ml', buy: '480 ml', exact: '411 ml required', approximate: true },
    { unit: 'tbsp', buy: '32 tbsp', exact: '27.4 tbsp required', approximate: true },
    { unit: 'tsp', buy: '96 tsp', exact: '82.3 tsp required', approximate: true },
    { unit: 'cup', buy: '2 cups', exact: '1.71 cups required', approximate: true },
  ] },
