...
export function FoodSearchSources({ value, onChange, compact = false, disabled = false }: { value: FoodSearchSourceSelection; onChange: (value: FoodSearchSourceSelection) => void; compact?: boolean; disabled?: boolean }) {
